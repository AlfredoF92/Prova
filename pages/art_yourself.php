...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header color-yourself">Yourself</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			<ul class="nav nav-tabs color-yourself" style="margin-bottom: 30px">
                                <li class="active"><a href="#home" data-toggle="tab" aria-expanded="true">Home</a>
                                </li>
                                <li class=""><a href="#profile" data-toggle="tab" aria-expanded="false">Mente</a>
                                </li>
                                <li class=""><a href="#messages" data-toggle="tab" aria-expanded="false">Sport</a>
                                </li>
                                <li class=""><a href="#settings" data-toggle="tab" aria-expanded="false">Fitness</a>
                                </li>
                                <li><a href="#home" data-toggle="tab" aria-expanded="true">Home</a>
                                </li>
                                <li class=""><a href="#profile" data-toggle="tab" aria-expanded="false">Dieta</a>
                                </li>
			...
			<div class="tab-content">
				...
				<div class="col-lg-4">
					<div class="panel panel-default">
						<div class="panel-heading">
							Da www.efficacemente.com
						</div>

						<img src="../image/articles/01.PNG" width="100%" height="auto" alt=""/>
				...
				<div class="col-lg-4">
					<div class="panel panel-default">
						...
						<img src="../image/articles/02.PNG" width="100%" height="auto" alt=""/>
				...
				<div class="col-lg-4">
					<div class="panel panel-default">
						...
						<img src="../image/articles/03.PNG" width="100%" height="auto" alt=""/>
